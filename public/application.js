...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ballerboardEvents = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateBaller = function onCreateBaller(event) {
	  // console.log('on createBaller invoked')
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.createBaller(data).then(onShowAllBallers).catch(ui.createBallerFailure);
	};

	var onShowAllBallers = function onShowAllBallers(event) {
	  // console.log('onShowAllBallers invoked')
	  console.log(event.target);
	  api.showAllBallers().then(ui.showAllBallersSuccess).catch(ui.showAllBallersFailure);
	};

	var onDeleteBaller = function onDeleteBaller(event) {
	  // console.log('delete is working')
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.deleteBaller(data.baller.id).then(onShowAllBallers)
	  // .then(ui.deleteBallerSuccess)
	  .catch(ui.deleteBallerFailure);
	  //   .catch(ui.deleteBallerFailure)
	};

	var onUpdateBaller = function onUpdateBaller(event) {
	  // console.log('update is working')
	  var data = getFormFields(event.target);
	  // console.log(data)
	  event.preventDefault();
	  api.updateBaller(data).then(onShowAllBallers).catch(ui.updateBallerFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createBaller = function createBaller(baller) {
	...
	var showAllBallers = function showAllBallers(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/ballers',
	    method: 'GET',
	    headers: {
	...
	var deleteBaller = function deleteBaller(data) {
	  // console.log(data)
	  return $.ajax({
	...
	var updateBaller = function updateBaller(baller) {
	...
	module.exports = {
	  ...
	  showAllBallers: showAllBallers,
	  deleteBaller: deleteBaller,
	  updateBaller: updateBaller
	  // updateBaller
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showBallersTemplate = __webpack_require__(16);
	var createBallerSuccess = function createBallerSuccess(data) {
	  $('#sign-in-log').text('Baller deleted');
	};

	var createBallerFailure = function createBallerFailure(error) {
	  // console.log(error)
	};

	var showAllBallersSuccess = function showAllBallersSuccess(data) {
	  ...
	  var showBallersHtml = showBallersTemplate({
	    ballers: data.ballers });
	  $('p').append(showBallersHtml);
	};

	var showAllBallersFailure = function showAllBallersFailure() {};

	var deleteBallerSuccess = function deleteBallerSuccess() {
	  $('#sign-in-log').text('Baller deleted');
	};

	var deleteBallerFailure = function deleteBallerFailure() {
	  $('.delete-baller').val('');
	  $('#delete-baller-modal').modal('hide');
	  $('#sign-in-log').text('');
	};

	var updateBallerFailure = function updateBallerFailure() {
	  $('.update-baller').val('');
	  $('#update-baller-modal').modal('hide');
	...
	module.exports = {
	  deleteBallerFailure: deleteBallerFailure,
	  deleteBallerSuccess: deleteBallerSuccess,
	  showAllBallersSuccess: showAllBallersSuccess,
	  showAllBallersFailure: showAllBallersFailure,
	  createBallerFailure: createBallerFailure,
	  createBallerSuccess: createBallerSuccess,
	  updateBallerFailure: updateBallerFailure
	  //
	  // $('.delete-baller').val('')
	  //   $('#delete-baller-modal').modal('hide')
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"card\">\n<div class=\"card-block\">\n    <h1> Baller ID #"
	    ...
	    + "</h1>\n    <h1> Name: "
	    + alias1(((helper = (helper = helpers.first_name || (depth0 != null ? depth0.first_name : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"first_name","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " "
	    + alias1(((helper = (helper = helpers.last_name || (depth0 != null ? depth0.last_name : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"last_name","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</h1>\n  <ul> Team: "
	    + alias1(((helper = (helper = helpers.team || (depth0 != null ? depth0.team : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"team","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n  <ul> Position: "
	    + alias1(((helper = (helper = helpers.position || (depth0 != null ? depth0.position : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"position","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n    <ul>Points Per Game: "
	    + alias1(((helper = (helper = helpers.buckets || (depth0 != null ? depth0.buckets : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"buckets","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n    <ul>Rebounds Per Game: "
	    + alias1(((helper = (helper = helpers.rpg || (depth0 != null ? depth0.rpg : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"rpg","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n    <ul>Assists Per Game: "
	    + alias1(((helper = (helper = helpers.apg || (depth0 != null ? depth0.apg : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"apg","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n    <ul>Sponsors: "
	    + alias1(((helper = (helper = helpers.sponsors || (depth0 != null ? depth0.sponsors : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"sponsors","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n    <ul>Shoes: "
	    + alias1(((helper = (helper = helpers.shoes || (depth0 != null ? depth0.shoes : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"shoes","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n    <ul>Catchphrase: "
	    + alias1(((helper = (helper = helpers.catchphrase || (depth0 != null ? depth0.catchphrase : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"catchphrase","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " </ul>\n</div>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.ballers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "8945fc6bc07295b178efbb942ecca8b8.jpg";
